	...
	<div class="row sortable">
      <div class="col l3 m6 s12">
        <div class="card-panel stats-card purple lighten-2 white-text z-depth-2">
		  ...
		  <p>
          <div class="name">Today's Earning</div></p>
        </div>
      </div>
      <div class="col l3 m6 s12">
        <div class="card-panel stats-card indigo lighten-2 white-text z-depth-2">
		  ...
		  <p>
          <div class="name">Total Earnings</div></p>
        </div>
      </div>
      <div class="col l3 m6 s12">
          ...
          <div class="content">
            <table class="table">
              <tbody>
                <tr>
                  <td>
                    <img src="${pageContext.request.contextPath}/static/assets/core/flagIcons/in.png" alt="India">&ensp; Rocky</td>
                ...
                <tr>
                  <td>
                    <img src="${pageContext.request.contextPath}/static/assets/core/flagIcons/us.png" alt="Unated States">&ensp; Rose</td>
                  <td class="right-align">
                ...
                <tr>
                  <td>
                    <img src="${pageContext.request.contextPath}/static/assets/core/flagIcons/br.png" alt="Brazil">&ensp; Yummy</td>
                  <td class="right-align">
                ...
                <tr>
                  <td>
                    <img src="${pageContext.request.contextPath}/static/assets/core/flagIcons/tr.png" alt="Turkey">&ensp; Scarllate</td>
                  <td class="right-align">
                ...
                <tr>
                  <td>
                    <img src="${pageContext.request.contextPath}/static/assets/core/flagIcons/ru.png" alt="Russia">&ensp; Ebby</td>
                  <td class="right-align">
                ...
                <tr>
                  <td>
                    <img src="${pageContext.request.contextPath}/static/assets/core/flagIcons/de.png" alt="Germany">&ensp; Tanny</td>
                  <td class="right-align">
                ...
                <tr>
                  <td>
                    <img src="${pageContext.request.contextPath}/static/assets/core/flagIcons/fr.png" alt="France">&ensp; Ramesh</td>
                  <td class="right-align">
                ...
                <tr>
                  <td>
                    <img src="${pageContext.request.contextPath}/static/assets/core/flagIcons/it.png" alt="Italy">&ensp; Bablu</td>
                  <td class="right-align">
