		...
		<section class="content bgcolor-1">
			...
			<form:form action="signup" method="post" modelAttribute="user">
				<span class="input input--nao"> <input
					...
					for="input-1"> <span
						class="input__label-content input__label-content--nao">FullName*</span>
				...
				<span class="input input--nao"> <input
					...
					for="input-1"> <span
						class="input__label-content input__label-content--nao">Username*</span>
				</label> <svg class="graphic graphic--nao" width="300%" height="100%"
						viewBox="0 0 1200 60" preserveAspectRatio="none">
						<path
							d="M0,56.5c0,0,298.666,0,399.333,0C448.336,56.5,513.994,46,597,46c77.327,0,135,10.5,200.999,10.5c95.996,0,402.001,0,402.001,0" />
								...
								<form class="ac-custom ac-checkbox ac-checkmark"
									...
									<ul>
										<li><input id="cb6" name="cb6" type="checkbox"><label
											for="cb6">I Have Understood and Agreed to PMG's Terms</label></li>
									</ul>
								</form>
							</section>
						</div>
